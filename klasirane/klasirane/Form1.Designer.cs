...
namespace klasirane
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = " Коя максимална оценка искате да намерите";
			// 
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(342, 41);
			...
			this.textBox2.Size = new System.Drawing.Size(300, 160);
